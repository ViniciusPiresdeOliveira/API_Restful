...
public class EstoqueService {
	...
	/*public List<EstoqueProdutoDTO> findEstoqueProdutoDTO(){
		...
		if (!listEstoque.isEmpty()) {
			...
			for(Estoque estoque : listEstoque) {
				...
				} else if (estoque.getProduto() == null && estoque.getProduto() != null){
					Produto produto = produtoService.findById(estoque.getProduto());
